...
let companies = ['AAPL', 'MSFT', 'GOOGL']
let API_URL = `https://financialmodelingprep.com/api/v3/historical-price-full/${companies[0]}?timeseries=30&apikey=${config.FMP_API_KEY}`
